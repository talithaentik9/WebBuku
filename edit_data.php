...
<html>
  <head>
    <title>List Buku from talitha library </title>
    <style type="text/css">
      * {
  ...
  <body>
      <center>
        <h1>Edit <?php echo $data['judul']; ?></h1>
      <center>
      ...
      <section class="base">
        ...
        <div>
          ...
          <i style="float: left;font-size: 11px;color: red">Abaikan jika tidak merubah gambar data</i>
        </div>
        <div>
