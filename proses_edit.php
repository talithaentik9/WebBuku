  ...
  if($gambar != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, '../gambar'.$gambar); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE data SET judul = '$judul', pengarang = '$pengarang', tahun = '$tahun', genre = '$genre', gambar = '$gambar'";
                    $query .= "WHERE id = '$id'";
      ...
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      $query  = "UPDATE data SET judul = '$judul', pengarang = '$pengarang', penerbit = '$penerbit', tahun = '$tahun' , genre = '$genre'";
      $query .= "WHERE id = '$id'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
